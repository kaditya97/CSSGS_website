...
<?php
$id = $_GET['id'];
$result = $db->prepare("SELECT * FROM client where id= :post_id");
        ...
        <div class="row">
          <div class="col-md-9">
            ...
            <article class="post-content"> <span class="post-meta meta-data"><span><i class="fa fa-calendar"></i> Posted on <?php echo $row['date']; ?></span> <span></i> </span></span>
              <div class="featured-image"> <img src="uploads/client/<?php echo $row['file']; ?>" alt=""> </div>
              <div style="word-break: break-all"><?php echo $row['client_detail']; ?></div>
              <div class="post-meta">
