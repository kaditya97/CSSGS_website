...
<div id="page-wrapper">
	<div class="graphs">
		<h3 class="blank1">All Services</h3>
		<div class="xs tabls">
	...
	*/
						...
						$result = $db->prepare("SELECT * FROM service  ORDER BY id DESC LIMIT $start, $limit");
						$result->execute();
		...
		<table class="table">
			...
			?>
				...
				<tr>
					...
					<td><img src="../uploads/service/<?php echo $row['file']; ?>" alt="" class="img-responsive" style=" height:50px; width:50px;"></td>
					<td>
						<a href="../service-detail.php?id=<?= $row['id'] ?>" target="_blank" class="fa fa-eye-slash btn btn-xs btn-primary">View</a>
						<a href="delete-service.php?id=<?= $row['id'] ?>" class="fa fa-eraser btn btn-xs btn-success warning_4 delbtn">Delete</a>
