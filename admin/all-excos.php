	...
	<div class="graphs">
		...
		<div class="xs tabls">
			<div class="panel-body1">
				<?php if (get("success")) : ?>
					<div>
						<?= App::message("success", "Successfully deleted an executive member!") ?>
					</div>
				<?php endif; ?>
				<table class="table">
					<thead>
		...
		<table class="table">
			...
			?>
				<tr>
					...
					<td><img src="../uploads/member/<?php echo $row['file']; ?>" alt="" class="img-responsive" style=" height:50px; width:50px;"></td>
					<td>
