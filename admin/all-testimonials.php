...
<div id="page-wrapper">
			...
			<div class="panel-body1">
				...
				<table class="table">
					...
					<tbody>
						...
						$tbl_name = "testimonial";		//your table name
	...
	*/
						...
						$result = $db->prepare("SELECT * FROM testimonial  ORDER BY id DESC LIMIT $start, $limit");
						$result->execute();
		...
		<table class="table">
			...
			?>
				...
				<tr>
					...
					<td><img src="../uploads/testimonial/<?php echo $row['file']; ?>" alt="" class="img-responsive" style=" height:50px; width:50px;"></td>
					<td>
						<a href="../testimonial-detail.php?id=<?= $row['id'] ?>" target="_blank" class="fa fa-eye-slash btn btn-xs btn-primary">View</a>
						<a href="delete-testimonial.php?id=<?= $row['id'] ?>" class="fa fa-eraser btn btn-xs btn-success warning_4 delbtn">Delete</a>
