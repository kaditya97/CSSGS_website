...
<div id="page-wrapper">
	...
	*/
						...
						$result = $db->prepare("SELECT * FROM project  ORDER BY id DESC LIMIT $start, $limit");
						$result->execute();
		...
		<table class="table">
			...
			?>
				...
				<tr>
					...
					<td>
						<a href="../project-detail.php?id=<?= $row['id'] ?>" target="_blank" class="fa fa-eye-slash btn btn-xs btn-primary">View</a>
						<a href="delete-project.php?id=<?= $row['id'] ?>" class="fa fa-eraser btn btn-xs btn-success warning_4 delbtn">Delete</a>
