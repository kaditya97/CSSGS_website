...
<div id="page-wrapper">
	<div class="graphs">
		<h3 class="blank1">All Blogs</h3>
		<div class="xs tabls">
			<div class="panel-body1">
				<?php if (get("success")) : ?>
					<div>
						<?= App::message("success", "Successfully deleted a Blog!") ?>
					</div>
				<?php endif; ?>
				<table class="table">
					<thead>
	...
	*/
						...
						$result = $db->prepare("SELECT * FROM blog  ORDER BY id DESC LIMIT $start, $limit");
						$result->execute();
		...
		<table class="table">
			...
			?>
				...
				<tr>
					...
					<td>
						<a href="../blog_post.php?id=<?= $row['id'] ?>" target="_blank" class="fa fa-eye-slash btn btn-xs btn-primary">View</a>
						<a href="delete-blog.php?id=<?= $row['id'] ?>" class="fa fa-eraser btn btn-xs btn-success warning_4 delbtn">Delete</a>
